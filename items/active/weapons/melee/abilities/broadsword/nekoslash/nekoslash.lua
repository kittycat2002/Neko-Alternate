...
NekoSlash = WeaponAbility:new()

function NekoSlash:init()
  self.cooldownTimer = self.cooldownTime
end

function NekoSlash:update(dt, fireMode, shiftHeld)
